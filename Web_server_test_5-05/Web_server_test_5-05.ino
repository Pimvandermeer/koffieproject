...
IPAddress ip(192, 168, 2, 197); // IP address, may need to change depending on network
EthernetServer server(45876);  // create a server at port 80
        ...
        while (client.connected()) {
            if (client.available()) {   // client data available to read
                ...
                if (c == '\n' && currentLineIsBlank) {
                    ...
                    if
                    (StrContains(HTTP_req, "GET /ajax_inputs")) {
                    ...
                    // else if (StrContains(HTTP_req, "GET /coffe.jpg")) {
                    //     webFile = SD.open("coffe.jpg");
                    //     if (webFile) {
                    //         client.println("HTTP/1.1 200 OK");
                    //         client.println();
                    //     }
                    // }
                    // else if (StrContains(HTTP_req, "GET /vergeer.png")) {
                    //     webFile = SD.open("vergeer.png");
                    //     if (webFile) {
                    //         client.println("HTTP/1.1 200 OK");
                    //         client.println();
                    //     }
